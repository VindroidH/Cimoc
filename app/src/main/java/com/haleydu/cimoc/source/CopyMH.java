...
//            keyword = jChineseConvertor.s2t(keyword);
    ...
    public String getUrl(String cid) {
        return "https://copymanga.site/h5/details/comic/".concat(cid);
    }

    @Override
    protected void initUrlFilterList() {
        filter.add(new UrlFilter("copymanga.site", "\\w+", 0));
    }
    ...
    public Request getInfoRequest(String cid) {
        String url = "https://api.copymanga.site/api/v3/comic2/".concat(cid);
        return new Request.Builder()
                .url(url)
                .addHeader("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Safari/537.36")
                .build();
    ...
    public Request getChapterRequest(String html, String cid) {
        String url = String.format("https://api.copymanga.site/api/v3/comic/%s/group/default/chapters?limit=500&offset=0", cid);
        return new Request.Builder()
                .url(url)
                .addHeader("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Safari/537.36")
                .build();
    ...
    public List<Chapter> parseChapter(String html, Comic comic, Long sourceComic) throws JSONException {
        ...
        try {
            ...
            while (keys.hasNext()) {
                ...
                String url = String.format("https://api.copymanga.site/api/v3/comic/%s/group/%s/chapters?limit=500&offset=0", comic.getCid(), path_word);
    ...
    public Request getImagesRequest(String cid, String path) {
        String url = StringUtils.format("https://copymanga.site/comic/%s/chapter/%s", cid, path);
        return new Request.Builder()
                .url(url)
                .addHeader("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Safari/537.36")
                .build();
