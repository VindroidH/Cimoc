...
public class TaskActivity extends CoordinatorActivity implements TaskView {
            ...
            case DIALOG_REQUEST_OPERATION:
                ...
                switch (index) {
                    ...
                    case OPERATION_DELETE:
                        ...
                        Long sourceComic = Long.parseLong(mSavedTask.getSource() + "00" + mSavedTask.getId());
                        Long id = Long.parseLong(sourceComic + "00" + 0);
            ...
            switch (item.getItemId()) {
                ...
                case R.id.task_delete:
                    ...
                    for (Task task : mTaskAdapter.getDateSet()) {
                        Long sourceComic = Long.parseLong(task.getSource() + "00" + task.getId());
                        Long id = Long.parseLong(sourceComic + "00" + i);
    ...
    private void startReader(String path, boolean preview) {
        ...
        for (Task t : mTaskAdapter.getDateSet()) {
            Long sourceComic = Long.parseLong(t.getSource() + "00" + t.getId());
